...
xlim([0.8 4.0])
ylim([0 1.0]) 
title("R vs [T]_0 for K_d=60pM, NAAP Unscaled=2nM")
xlabel("[T]_{0}/K_{d}")
ylabel("R_{2nM}")
...
%% Roots
p =[ -0.1935    1.8601   -6.1544    7.7645   -2.8160]
r=roots(p)

% sub x value into derivative to check if slope matches with y_p1_slope
slope=polyval(deri, 1.8448) % 0.0504 is the x value for y =0.5