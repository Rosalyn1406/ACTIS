...
grid on 
title("R vs [T]_0 for K_d=60pM, NAAP Unscaled=20pM")
xlabel("[T]_{0}/K_{d}")
ylabel("R_{20PM}")
...
%% Roots
p =[0.0003    0.1596   -0.1236   -0.5732    0.1762]
r=roots(p)

% sub x value into derivative to check if slope matches with y_p1_slope
slope=polyval(deri,0.2957) % 0.2098 is the x value for y =0.5
